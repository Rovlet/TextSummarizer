...
def prepare_arguments():
    ...
    data_args = DataTrainingArguments(text_column=TEXT_COLUMN, summary_column=SUMMARY_COLUMN,
                                      train_file=TRAIN_FILE, test_file=TEST_FILE, validation_file=VALID_FILE)
    training_args = TFTrainingArguments(output_dir=OUTPUT_DIR, overwrite_output_dir=True, do_train=True, do_eval=True, per_device_train_batch_size=TRAIN_BATCH_SIZE, per_gpu_eval_batch_size=EVAL_BATCH_SIZE)
    return model_args, data_args, training_args


def main():
    # parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TFTrainingArguments))
    model_args, data_args, training_args = prepare_arguments()
